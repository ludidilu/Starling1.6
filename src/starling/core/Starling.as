...
package starling.core
{
    ...
    public class Starling extends EventDispatcher
    {
		...
		public var drawToBitmapDataCallBack:Function;
        ...
        public function render():void
        {
			...
			if(drawToBitmapDataCallBack){
				
				var bitmapData:BitmapData = new BitmapData(viewPort.width,viewPort.height,true,0x00000000);
				
				context.drawToBitmapData(bitmapData);
				
				drawToBitmapDataCallBack(bitmapData);
				
				drawToBitmapDataCallBack = null;
			}
